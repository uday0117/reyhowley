import 'dart:convert';
import 'package:reyhowley/features/brands/controllers/brands_controller.dart';
import 'package:reyhowley/features/brands/domain/repositories/brands_repository.dart';
import 'package:reyhowley/features/brands/domain/repositories/brands_repository_interface.dart';
import 'package:reyhowley/features/brands/domain/services/brands_service.dart';
import 'package:reyhowley/features/brands/domain/services/brands_service_interface.dart';
import 'package:reyhowley/features/business/controllers/business_controller.dart';
import 'package:reyhowley/features/business/domain/repositories/business_repo.dart';
import 'package:reyhowley/features/business/domain/repositories/business_repo_interface.dart';
import 'package:reyhowley/features/business/domain/services/business_service.dart';
import 'package:reyhowley/features/business/domain/services/business_service_interface.dart';
import 'package:reyhowley/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:reyhowley/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:reyhowley/features/home/controllers/advertisement_controller.dart';
import 'package:reyhowley/features/home/controllers/home_controller.dart';
import 'package:reyhowley/features/home/domain/repositories/advertisement_repository.dart';
import 'package:reyhowley/features/home/domain/repositories/advertisement_repository_interface.dart';
import 'package:reyhowley/features/home/domain/repositories/home_repository.dart';
import 'package:reyhowley/features/home/domain/repositories/home_repository_interface.dart';
import 'package:reyhowley/features/home/domain/services/advertisement_service.dart';
import 'package:reyhowley/features/home/domain/services/advertisement_service_interface.dart';
import 'package:reyhowley/features/home/domain/services/home_service.dart';
...
import 'package:reyhowley/features/banner/domain/repositories/banner_repository.dart';
import 'package:reyhowley/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:reyhowley/features/banner/domain/services/banner_service.dart';
import 'package:reyhowley/features/banner/domain/services/banner_service_interface.dart';
import 'package:reyhowley/features/cart/domain/repositories/cart_repository.dart';
import 'package:reyhowley/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:reyhowley/features/cart/domain/services/cart_service.dart';
import 'package:reyhowley/features/cart/domain/services/cart_service_interface.dart';
import 'package:reyhowley/features/category/controllers/category_controller.dart';
import 'package:reyhowley/features/category/domain/reposotories/category_repository.dart';
import 'package:reyhowley/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:reyhowley/features/category/domain/services/category_service.dart';
import 'package:reyhowley/features/category/domain/services/category_service_interface.dart';
import 'package:reyhowley/features/chat/controllers/chat_controller.dart';
import 'package:reyhowley/features/chat/domain/repositories/chat_repository.dart';
import 'package:reyhowley/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:reyhowley/features/chat/domain/services/chat_service.dart';
import 'package:reyhowley/features/chat/domain/services/chat_service_interface.dart';
import 'package:reyhowley/features/coupon/controllers/coupon_controller.dart';
import 'package:reyhowley/features/coupon/domain/services/coupon_service.dart';
import 'package:reyhowley/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:reyhowley/features/favourite/controllers/favourite_controller.dart';
import 'package:reyhowley/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:reyhowley/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:reyhowley/features/favourite/domain/services/favourite_service.dart';
import 'package:reyhowley/features/favourite/domain/services/favourite_service_interface.dart';
import 'package:reyhowley/features/flash_sale/controllers/flash_sale_controller.dart';
import 'package:reyhowley/features/flash_sale/domain/repositories/flash_sale_repository.dart';
import 'package:reyhowley/features/flash_sale/domain/repositories/flash_sale_repository_interface.dart';
import 'package:reyhowley/features/flash_sale/domain/services/flash_sale_service.dart';
import 'package:reyhowley/features/flash_sale/domain/services/flash_sale_service_interface.dart';
import 'package:reyhowley/features/html/controllers/html_controller.dart';
import 'package:reyhowley/features/html/domain/repositories/html_repository.dart';
import 'package:reyhowley/features/html/domain/repositories/html_repository_interface.dart';
import 'package:reyhowley/features/html/domain/services/html_service.dart';
...
import 'package:reyhowley/features/item/domain/repositories/campaign_repository.dart';
import 'package:reyhowley/features/item/domain/repositories/campaign_repository_interface.dart';
import 'package:reyhowley/features/item/domain/repositories/item_repository.dart';
import 'package:reyhowley/features/item/domain/repositories/item_repository_interface.dart';
import 'package:reyhowley/features/item/domain/services/campaign_service.dart';
import 'package:reyhowley/features/item/domain/services/campaign_service_interface.dart';
import 'package:reyhowley/features/item/domain/services/item_service.dart';
import 'package:reyhowley/features/item/domain/services/item_service_interface.dart';
import 'package:reyhowley/features/language/controllers/language_controller.dart';
import 'package:reyhowley/features/language/domain/repository/language_repository.dart';
import 'package:reyhowley/features/language/domain/repository/language_repository_interface.dart';
import 'package:reyhowley/features/language/domain/service/language_service.dart';
...
import 'package:reyhowley/features/address/domain/repositories/address_repository.dart';
import 'package:reyhowley/features/address/domain/repositories/address_repository_interface.dart';
import 'package:reyhowley/features/address/domain/services/address_service.dart';
import 'package:reyhowley/features/address/domain/services/address_service_interface.dart';
import 'package:reyhowley/features/auth/controllers/auth_controller.dart';
import 'package:reyhowley/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:reyhowley/features/auth/controllers/store_registration_controller.dart';
import 'package:reyhowley/features/auth/domain/reposotories/auth_repository.dart';
import 'package:reyhowley/features/auth/domain/reposotories/auth_repository_interface.dart';
import 'package:reyhowley/features/auth/domain/reposotories/deliveryman_registration_repository.dart';
import 'package:reyhowley/features/auth/domain/reposotories/deliveryman_registration_repository_interface.dart';
import 'package:reyhowley/features/auth/domain/reposotories/store_registration_repository.dart';
import 'package:reyhowley/features/auth/domain/reposotories/store_registration_repository_interface.dart';
import 'package:reyhowley/features/auth/domain/services/auth_service.dart';
import 'package:reyhowley/features/auth/domain/services/auth_service_interface.dart';
import 'package:reyhowley/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:reyhowley/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:reyhowley/features/auth/domain/services/store_registration_service.dart';
import 'package:reyhowley/features/auth/domain/services/store_registration_service_interface.dart';
import 'package:reyhowley/features/checkout/controllers/checkout_controller.dart';
import 'package:reyhowley/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:reyhowley/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:reyhowley/features/checkout/domain/services/checkout_service.dart';
import 'package:reyhowley/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:reyhowley/features/location/domain/repositories/location_repository.dart';
import 'package:reyhowley/features/location/domain/repositories/location_repository_interface.dart';
import 'package:reyhowley/features/location/domain/services/location_service.dart';
import 'package:reyhowley/features/location/domain/services/location_service_interface.dart';
import 'package:reyhowley/features/loyalty/controllers/loyalty_controller.dart';
import 'package:reyhowley/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:reyhowley/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:reyhowley/features/loyalty/domain/services/loyalty_service.dart';
import 'package:reyhowley/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:reyhowley/features/notification/controllers/notification_controller.dart';
import 'package:reyhowley/features/notification/domain/repository/notification_repository.dart';
import 'package:reyhowley/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:reyhowley/features/notification/domain/service/notification_service.dart';
import 'package:reyhowley/features/notification/domain/service/notification_service_interface.dart';
import 'package:reyhowley/features/onboard/controllers/onboard_controller.dart';
import 'package:reyhowley/features/onboard/domain/repository/onboard_repository.dart';
import 'package:reyhowley/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:reyhowley/features/onboard/domain/service/onboard_service.dart';
...
import 'package:reyhowley/features/order/domain/repositories/order_repository.dart';
import 'package:reyhowley/features/order/domain/repositories/order_repository_interface.dart';
import 'package:reyhowley/features/order/domain/services/order_service.dart';
...
import 'package:reyhowley/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:reyhowley/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:reyhowley/features/parcel/domain/services/parcel_service.dart';
import 'package:reyhowley/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:reyhowley/features/payment/controllers/payment_controller.dart';
import 'package:reyhowley/features/payment/domain/repositories/payement_repository.dart';
import 'package:reyhowley/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:reyhowley/features/payment/domain/services/payment_service.dart';
import 'package:reyhowley/features/payment/domain/services/payment_service_interface.dart';
import 'package:reyhowley/features/profile/controllers/profile_controller.dart';
import 'package:reyhowley/features/profile/domain/repositories/profile_repository.dart';
import 'package:reyhowley/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:reyhowley/features/profile/domain/services/profile_service.dart';
import 'package:reyhowley/features/profile/domain/services/profile_service_interface.dart';
import 'package:reyhowley/features/review/controllers/review_controller.dart';
import 'package:reyhowley/features/review/domain/repositories/review_repository.dart';
import 'package:reyhowley/features/review/domain/repositories/review_repository_interface.dart';
import 'package:reyhowley/features/review/domain/services/review_service.dart';
import 'package:reyhowley/features/review/domain/services/review_service_interface.dart';
import 'package:reyhowley/features/search/controllers/search_controller.dart';
import 'package:reyhowley/features/search/domain/repositories/search_repository.dart';
import 'package:reyhowley/features/search/domain/repositories/search_repository_interface.dart';
import 'package:reyhowley/features/search/domain/services/search_service.dart';
...
import 'package:reyhowley/features/splash/domain/repositories/splash_repository.dart';
import 'package:reyhowley/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:reyhowley/features/splash/domain/services/splash_service.dart';
...
import 'package:reyhowley/features/store/domain/repositories/store_repository.dart';
import 'package:reyhowley/features/store/domain/repositories/store_repository_interface.dart';
import 'package:reyhowley/features/store/domain/services/store_service.dart';
import 'package:reyhowley/features/store/domain/services/store_service_interface.dart';
import 'package:reyhowley/features/rental_module/rental_location_screen/controller/taxi_location_controller.dart';
import 'package:reyhowley/features/rental_module/home/controllers/taxi_home_controller.dart';
import 'package:reyhowley/features/rental_module/home/domain/repositories/taxi_home_repository.dart';
import 'package:reyhowley/features/rental_module/home/domain/repositories/taxi_home_repository_interface.dart';
import 'package:reyhowley/features/rental_module/home/domain/services/taxi_home_service.dart';
...
import 'package:reyhowley/features/rental_module/rental_cart_screen/domain/repository/taxi_cart_repository.dart';
import 'package:reyhowley/features/rental_module/rental_cart_screen/domain/repository/taxi_cart_repository_interface.dart';
import 'package:reyhowley/features/rental_module/rental_cart_screen/domain/services/taxi_cart_service.dart';
...
import 'package:reyhowley/features/rental_module/rental_favourite/domain/repositories/taxi_favourite_repository.dart';
import 'package:reyhowley/features/rental_module/rental_favourite/domain/repositories/taxi_favourite_repository_interface.dart';
import 'package:reyhowley/features/rental_module/rental_favourite/domain/services/taxi_favourite_service.dart';
import 'package:reyhowley/features/rental_module/rental_favourite/domain/services/taxi_favourite_service_interface.dart';
import 'package:reyhowley/features/rental_module/rental_location_screen/domain/repository/taxi_repository.dart';
import 'package:reyhowley/features/rental_module/rental_location_screen/domain/repository/taxi_repository_interface.dart';
import 'package:reyhowley/features/rental_module/rental_location_screen/domain/services/taxi_location_service.dart';
import 'package:reyhowley/features/rental_module/rental_location_screen/domain/services/taxi_location_service_interface.dart';
import 'package:reyhowley/features/rental_module/rental_order/controllers/taxi_order_controller.dart';
import 'package:reyhowley/features/rental_module/rental_order/domain/repository/taxi_order_repository.dart';
import 'package:reyhowley/features/rental_module/rental_order/domain/repository/taxi_order_repository_interface.dart';
import 'package:reyhowley/features/rental_module/rental_order/domain/services/taxi_order_service.dart';
import 'package:reyhowley/features/rental_module/rental_order/domain/services/taxi_order_service_interface.dart';
import 'package:reyhowley/features/rental_module/vendor/controllers/taxi_vendor_controller.dart';
import 'package:reyhowley/features/rental_module/vendor/domain/repositories/taxi_vendor_repository.dart';
import 'package:reyhowley/features/rental_module/vendor/domain/repositories/taxi_vendor_repository_interface.dart';
import 'package:reyhowley/features/rental_module/vendor/domain/services/taxi_vendor_service.dart';
import 'package:reyhowley/features/rental_module/vendor/domain/services/taxi_vendor_service_interface.dart';
import 'package:reyhowley/features/verification/controllers/verification_controller.dart';
import 'package:reyhowley/features/verification/domein/reposotories/verification_repository.dart';
import 'package:reyhowley/features/verification/domein/reposotories/verification_repository_interface.dart';
import 'package:reyhowley/features/verification/domein/services/verification_service.dart';
import 'package:reyhowley/features/verification/domein/services/verification_service_interface.dart';
import 'package:reyhowley/features/wallet/controllers/wallet_controller.dart';
import 'package:reyhowley/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:reyhowley/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:reyhowley/features/wallet/domain/services/wallet_service.dart';
