...
import 'package:reyhowley/features/auth/widgets/sign_in/manual_login_widget.dart';
import 'package:reyhowley/features/auth/widgets/sign_in/otp_login_widget.dart';
import 'package:reyhowley/features/auth/widgets/social_login_widget.dart';
...
import 'package:reyhowley/helper/centralize_login_helper.dart';
  ...
  void _otpLogin(
    ...
    if (_formKeyLogin!.currentState!.validate()) {
      if (!phoneValid.isValid) {
        ...
        authController.firebaseVerifyPhoneNumber(
          numberWithCountryCode,
          '',
          loginType.name,
          fromSignUp: true,
