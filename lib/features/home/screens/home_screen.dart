...
import 'package:reyhowley/features/home/screens/modules/food_home_screen.dart';
import 'package:reyhowley/features/home/screens/modules/grocery_home_screen.dart';
import 'package:reyhowley/features/home/screens/modules/pharmacy_home_screen.dart';
import 'package:reyhowley/features/home/screens/modules/shop_home_screen.dart';
import 'package:reyhowley/features/home/screens/web_new_home_screen.dart';
import 'package:reyhowley/features/home/widgets/all_store_filter_widget.dart';
import 'package:reyhowley/features/home/widgets/cashback_dialog_widget.dart';
import 'package:reyhowley/features/home/widgets/cashback_logo_widget.dart';
import 'package:reyhowley/features/home/widgets/module_view.dart';
import 'package:reyhowley/features/home/widgets/refer_bottom_sheet_widget.dart';
...
import 'package:reyhowley/features/rental_module/home/screens/taxi_home_screen.dart';
...
class HomeScreen extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload, {bool fromModule = false}) async {
    // Prevent multiple simultaneous API calls and flickering
    if (!reload && !Get.find<HomeController>().shouldLoadHomeData()) {
      return;
    }

    Get.find<HomeController>().setLoadingHomeData(true);
    ...
    try {
      ...
      Get.find<HomeController>().markHomeDataLoaded();
    }
  }
                  ...
                  : SafeArea(
                      child: RefreshIndicator(
                        onRefresh: () async {
                          ...
                          if (Get.find<HomeController>().isLoadingHomeData) {
                            return;
                          }
